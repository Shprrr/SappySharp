...
public partial class frmAssembler : Window
{
    ...
    private void Command1_Click()
    {
        ...
        FileDir = Left(txtFile.Text, Len(txtFile.Text) - Len(gCommonDialog.VBGetFileTitle(txtFile.Text)));
        ChDir(FileDir);
        Compile(gCommonDialog.VBGetFileTitle(txtFile.Text));
    ...
    private void Command3_Click()
    {
        ...
        int filterIndex = 1;
        if (!gCommonDialog.VBGetOpenFileName(ref FileTit, ref fileTile, ref readOnly, ref filter, ref filterIndex)) return;
    ...
    private void Command4_Click()
    {
        ...
        int filterIndex = 1;
        if (!gCommonDialog.VBGetOpenFileName(ref foo, ref fileTile, ref readOnly, ref filter, ref filterIndex)) return;
        txtROM.Text = foo;
    }
}
